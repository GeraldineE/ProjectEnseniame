...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post tutors_url, params: { tutor: { email: @tutor.email, last_name: @tutor.last_name, name: @tutor.name } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { email: @tutor.email, last_name: @tutor.last_name, name: @tutor.name } }
